...
This repo is a fork of the original ORB-SLAM3 Repo (https://github.com/UZ-SLAMLab/ORB_SLAM3), I simply updated it wo run with my environment on windows using WSL2 Ubuntu 22.04. This required following the instructions from bharath5673 (https://gist.github.com/bharath5673/4295e666cbe654a83226a2549a972c4f) and making small edits to the code to run with the newer cmake version and python versions. For convienience I've concated the README file isntructions below.
